 ...
 *  @param {string} propertyForKey - (optional): Assigns a property on the array element with the key from the input object
 */
 ...
 * @param {string} srcProperty - Name of the property whose value will be moved
 * @param {string} destPath - New path to put the property
 * Example:
 *   o =  {a: 42}
